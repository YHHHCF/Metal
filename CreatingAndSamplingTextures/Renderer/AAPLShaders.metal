...
{
    // mag_filter::linear defines how to sample when the area is larger than the texture
    // min_filter::linear defines how to sample when the area is smaller than the texture
