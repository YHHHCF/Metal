...
//        mtkView.depthStencilPixelFormat = MTLPixelFormatDepth32Float; // is this needed?
...
//        pipelineStateDescriptor.depthAttachmentPixelFormat = mtkView.depthStencilPixelFormat;
        ...
        // MTLResourceStorageModePrivate mode allows the data to be kept entirely to GPU (or driver)
        // private memory that will never be accessed by the CPU directly
        ...
        // Indicate that a max of 3 vertex buffers will be set for each command.
        // And 0 fragment buffers for each command
